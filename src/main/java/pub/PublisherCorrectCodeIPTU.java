...
public class PublisherCorrectCodeIPTU extends Publisher{
    ...
    protected JsonObject mountJson() {
        ...
        json.addProperty("type", "IPTU_CORRECT");
    ...
    protected void publish(JsonObject json) {
        ProducerRecord<String,JsonObject> record = new ProducerRecord<String,JsonObject>(topic, "CORRECT:" + Constants.customizedKeyTagIptu+ ":" + uniqueID, json);
