...
public class PublisherCorrectCodeICMS extends Publisher{
    ...
    protected JsonObject mountJson() {
        ...
        json.addProperty("type", "ICMS_CORRECT");
    ...
    protected void publish(JsonObject json) {
        ProducerRecord<String,JsonObject> record = new ProducerRecord<String,JsonObject>(topic, "CORRECT:" + Constants.customizedKeyTagIcms+ ":" + uniqueID, json);
